...
function App() {
  ...
  //Created a state to use in other to change the visiblity of the blog input component
...
const submitBlog=(e)=>{
  ...
  setTitle("")
  setUrl("")
  //on subbmittion of the form make the form not visible
  setcreateNewNote(!createNewNote)
//console.log("working")
}
...
console.log(user)
  return (
    <div className="App">
      ...
      noVote={noVote}
      submit={submitBlog}
      visibility={createNewNote}
      addNewBlog={()=>setcreateNewNote(!createNewNote)}
      cancelNewBlog={()=>setcreateNewNote(!createNewNote)}
    />}
